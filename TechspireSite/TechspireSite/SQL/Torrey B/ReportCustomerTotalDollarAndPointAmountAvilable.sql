...
Customer.first_name AS First_Name, Customer.last_name AS Last_Name, (concat('$', cast(Totals.total  AS decimal(18,2)))) AS Customer_Spending_Total,
Points.total AS Customer_Total_Points, Employee.first_name AS Employee_FName, Employee.last_name AS Employee_LName
FROM (SELECT
