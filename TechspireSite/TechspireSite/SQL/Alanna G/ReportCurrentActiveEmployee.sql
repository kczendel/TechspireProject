...
--For example, the client could use this report to call employees in the event of an emergency or to call someone in to work if shorthanded. This report displays all active employees, phone number, and their job title.  
