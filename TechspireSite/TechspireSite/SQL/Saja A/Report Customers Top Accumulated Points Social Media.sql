...
-- Row Number, First Name, Last Name, Points Accumulated, Email, Social Media Type, Customer Social Media Name
-- ,,,right,,,

SELECT ROW_NUMBER() 
OVER(ORDER BY Customer.point_total DESC) AS Row_Num, 
Customer.first_name AS "First Name",
Customer.last_name AS "Last Name",
Customer.point_total AS "Points Accumulated",
...
WHERE CustomerStatus.id = 1 AND SocialMediaType.social_media_name = 'Facebook'
